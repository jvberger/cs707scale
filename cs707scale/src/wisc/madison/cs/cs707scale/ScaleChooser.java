...
public class ScaleChooser extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		File file = new File(getExternalFilesDir(null), "Settings.xml");
		if (file != null && file.exists())
		{
			try {
	            ...
	            NodeList scaleLocation = doc.getElementsByTagName("scaleLocation");
	            if (scaleLocation.getLength() != 0) {
	            	currentDirectory = scaleLocation.item(0).getTextContent();
